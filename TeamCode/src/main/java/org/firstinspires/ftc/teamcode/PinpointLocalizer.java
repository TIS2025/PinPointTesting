...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 6319.711109197182; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 7679.627052963716; // x position of the perpendicular encoder (in tick units)
    }
