...
//@Disabled
//@Deprecated
public class Auto_Specimen_Blue extends LinearOpMode {
    ...
    public static Vector2d sample3pick = new Vector2d(-47,38);
    public static Vector2d specimen_1pick = new Vector2d(-36,61);
    public static Vector2d specimen_23pick = new Vector2d(-36,60);
...
//                //SAMPLE 3 TO OBS
                ...
                .strafeToLinearHeading(sample3pick,Math.toRadians(-125))
