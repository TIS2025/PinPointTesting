...
public class Auto_Specimen_Red extends LinearOpMode {
    ...
    public static Vector2d sample2pick = new Vector2d(42,-42);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action autoSequence = drive.actionBuilder(start_pose)
                ...
                .strafeToLinearHeading(sample1pick,Math.PI/4)
...
//                //SAMPLE 2 TO OBS
                ...
                .strafeToLinearHeading(sample2pick,Math.PI/4)
...
//                //SAMPLE 3 TO OBS
                ...
                .strafeToLinearHeading(sample3pick,Math.PI/4)
                .afterTime(0, CrazySpecimenSeq.Specimen3Pick_Drop(arm,slider))
                .waitSeconds(0.5)
                .setReversed(true)
                .splineToLinearHeading(new Pose2d(specimen_1pick,-Math.PI/2),-Math.PI/3)
//                .waitSeconds(0.3)
//                //FIRST SPECIMEN DROP
...
//                //FOURTH SPECIMEN DROP
                ...
                .waitSeconds(0.25)
                .setReversed(true)
                .splineToConstantHeading(specimen4drop,Math.PI/2)
                .waitSeconds(0.15)
                //PARKING
        ...
        if(opModeInInit()) {
            Actions.runBlocking(CrazySpecimenSeq.AutoSpecimenInit(arm,slider));
        }
